...
namespace TicTacToe2
{
    internal class Program
    {
        static void Main(string[] args)
        {
                ...
                else if (input == 2)
                {
                    while (GameOver == false)  // BEGGINING OF GAME LOOP
                    {
                        ...
                        while (z == 0) //Bot playing
                        {
                            ...
                            int place = rnd.Next(1, 10);

                            bool slovo = UsedNumbers.Contains(place.ToString());

                            if (slovo == false)
                            {

                                Player2.Add(place.ToString());
                                BoardMarks[Int32.Parse(place.ToString())] = "O";
                                z = 1;
                            ...
                            UsedNumbers.Add(place.ToString());
                            GameOver = CheckForP2();
            ...
            //koukam jestli se hralo pokud ne tak se skipne
